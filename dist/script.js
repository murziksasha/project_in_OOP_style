...
function () {
  ...
  _createClass(Difference, [{
    ...
    key: "hideItems",
    value: function hideItems(education) {
      education.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
          //последний элемент не скроется со страницы
    ...
    value: function render() {
      ...
      this.btns.forEach(function (item) {
        ...
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.showSlides(_this2._slideIndex);
        });
      });
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            ...
            _this2.container.insertBefore(active, _this2.slides[0]); //инсерт бефор - поместить перед первым элементом
